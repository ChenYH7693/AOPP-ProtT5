...
The project uses the pretrained [`Rostlab/prot_t5_xl_uniref50`](https://huggingface.co/Rostlab/prot_t5_xl_uniref50) encoder and supports configurable fine-tuning, threshold optimization, early stopping, EMA, focal loss, AMP, and evaluation visualization.
